                    ...
                    <tbody>
                        <tr v-for="slider in arraySlider" :key="slider.id" >
                            ...
                            <td v-text="slider.titulo"></td>
                             <td >
                                 <a :href="slider.url" v-text="slider.nombre"></a>
                             </td>
                ...
                <div class="modal-body boxContenedor">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div  class="form-group row" v-if="tramites!=null">
                            <label class="col-md-3 form-control-label" for="text-input">Proyecto3</label>
                            <div class="col-md-9">
...
import { VueEditor } from "vue2-editor";
    export default {
       ...
       methods:{
           listarSlider(page,buscar){
               var url="pr?page="+page + "&buscar="+buscar;
  ...
  if (result.value) {
   ...
   console.log(this.tramite);
                                axios.post('admin/archivo_tramite/registera_p',{
                                    ...
                                    'id1': this.archivo,
                                        ...
                                        console.log(response.data);
                                    if(response.data!=1){
                                        swal.fire('Ya asigno este archivo a este proyecto','','error');
