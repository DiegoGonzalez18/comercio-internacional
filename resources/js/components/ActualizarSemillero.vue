     ...
     <main class="main ">
        ...
        <li class="breadcrumb-item active">Dashboard</li>
         ...
         <div class="container-fluid">
             <div>
                  <center>  <h1>Actualizar Semillero</h1></center>
       ...
       methods:{
            ...
            informacion(){
               ...
               me.contenido_id=this.$refs.seleccionado.value;
                 axios.post('admin/semillerosd',{'id':me.contenido_id}
                 ).then(function(response){
  ...
  if (result.value) {
   ...
   location.reload();
            ...
            registrarServicio(){
                                ...
                                axios.post('actualizarSemillero',{
                                    ...
                                    'contenido':this.content
                                     ...
                                     swal.fire('Semillero actualizado','','success');
                                      me.traercontenido();
                                      me.informacion();
