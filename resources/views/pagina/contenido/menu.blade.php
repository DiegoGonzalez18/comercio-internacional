                    ...
                    <div class="parallax-quote-in" style="padding: 0px;">
                        <div class="row">
                            <div class="col-md-4 col-sm-4 col-xs-5">
                                <a href="#">
                                    <img id="logo-header" class="logi"
                                         src="img/comercio.png" alt="Logo UFPS">
                                </a>
                            </div>

                            <div class="col-md-2 col-ms-1 col-xs-2 pull-right ac">
                                <a href="https://ww2.ufps.edu.co/"><img class="header-banner ac"
                                                                       src="img/ufps.png"
