...
<div id="menu-principal" class="header-v6 header-white-transparent header-sticky" style="position: relative;">
       ...
       @include('pagina.contenido.menuoficial')<!--/navbar-collapse-->
    ...
    <div class="container">
        ...
        <ul class="breadcrumb no-padding margin-bottom-10">
                              <li title="Ingresar a Inicio"><a href="/" style="font-style: italic; font-size: 14px;">Inicio</a></li>
                                         <li title="Universidad"><a href="/" style="font-style: italic; font-size: 14px;">Secretaría</a></li>
                                          <li class="active" title="" style="font-style: italic; font-size: 14px;">Proyecto</li>
    ...
    <!--=== fin breadcrumb ===-->
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="border-bottom: 3px solid #aa1916;">
                <!--            <h1 class="pull-left text-parallax capa-image2"
                    style="background-color: #aa1916;color: #fff; margin-top: 0px;
                     margin-bottom: 0px; padding: 6px; padding-left: 15px; padding-right: 15px;">
                    -->
                <div class="row">
                    <div class="col-md-10">
                                            <h1 class="pull-left" style="font-size: 36px;">
                            <b>{{$tramite['titulo']}}</b></h1>
                    </div>
                    <div class="col-md-2">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="shadow-wrapper">
                    ...
                    <div class="margin-top-20"><h2 style="color:#AA1916;"><b>Archivos del  Proyecto</b></h2></div>
    ...
    <li style="border:none;"><a href="/{{$archivos[0]['url']}} "
        class="text-submenu" style="border:none; border-bottom: 1px solid #DDDEDF;">
        <i class="fa fa-angle-double-right" aria-hidden="true"></i> {{$archivos[0]['nombre']}} </a></li>
    @endfor
            ...
            <div class="col-md-8 mb-margin-bottom-30">
                                <small class="pull-right" style="color:#aa1916;"><i class="fa fa-calendar"></i> {{$tramite['created_at']}}</small>
                            <div class="margin-bottom-40">

                                        <div class="headline margin-bottom-30"><h1>Descripción</h1></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-4 md-margin-bottom-40">
                        <div class="footer-main">
                            <a href="/"><img id="logo-footer" class="img-responsive" src="https://ww2.ufps.edu.co/public/imagenes/template/footer/logoufpsvertical.png" alt="Logo Pie de Página"></a>
                        </div>
                    </div><!--/col-md-3-->
                    <!-- End About -->
                    ...
                    <div class="col-md-3 col-sm-4  md-margin-bottom-40">
                        ...
                        <ul class="list-unstyled latest-list">
                            ...
                            <li><a href="https://ww2.ufps.edu.co/universidad/contratacion/1122" style="text-transform: none;">Convocatoria</a></li>
                            <li><a href="/" style="text-transform: none;">Calendarios</a></li>
                            <li><a href="https://ww2.ufps.edu.co/informacion/proceso_democratico_2019" style="text-transform: none;">Proceso democrático 2015</a></li>
