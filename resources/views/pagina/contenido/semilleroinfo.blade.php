                ...
                <ul class="breadcrumb no-padding margin-bottom-10">
                                      ...
                                      <li title="Ingresar a Inicio"><a href="/" style="font-style: italic; font-size: 14px;">Inicio</a></li>
                                                 <li title="Universidad"><a href="/" style="font-style: italic; font-size: 14px;">Secretaría</a></li>
                                                  <li class="active" title="Admisiones y Registro Académico" style="font-style: italic; font-size: 14px;">Semillero</li>
        ...
        <div class="row">
           <!--/col-md-3-->
            <div class="col-md-12 mb-margin-bottom-30">
                                <small class="pull-right" style="color:#aa1916;"><i class="fa fa-calendar"></i> {{$s['updated_at']}}</small>
                        ...
                        <tbody>
                                ...
                                @for($i = $c-1; $i >=0; $i--)
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-md-12">
                                                 <h4 style="text-transform: none;"><a href="/proyecto/{{$proyectos[$i]['id']}}"><b>{{$proyectos[$i]['titulo']}}</b></a></h4>
                                                 <p style="display:inline;"><i style="text-transform: none; color: #AA1916;"><i class="fa fa-calendar"></i> (publicado, {{$proyectos[$i]['updated_at']}})</i></p>
                                                </div>
                                        </div>
                                         </td>
                                </tr>
