        ...
        <div class="row">
            ...
            <ul class="breadcrumb no-padding margin-bottom-10">
                                  <li title="Ingresar a Inicio"><a href="/" style="font-style: italic; font-size: 14px;">Inicio</a></li>
                                             <li title="Universidad">
                                                 <a href="/" style="font-style: italic; font-size: 14px;">Secretaría</a></li>
                                              <li class="active"
                                              title="Admisiones y Registro Académico"
                                              style="font-style: italic; font-size: 14px;">Semilleros</li>
    ...
    <tbody>
            ...
            @for($i = $c-1; $i >=0; $i--)
                ...
                <td>
                    <div class="row">
                        <div class="col-md-12">
                             <h4 style="text-transform: none;"><a href="semilleroinfo/{{$novedades[$i]['id']}}"><b>{{$novedades[$i]['titulo']}}</b></a></h4>
                             <p style="display:inline;"><i style="text-transform: none; color: #AA1916;"><i class="fa fa-calendar"></i> (publicado, {{$novedades[$i]['updated_at']}})</i></p>
                            </div>
                    </div>
                     </td>
            </tr>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-4 md-margin-bottom-40">
                        <div class="footer-main">
                            <a href="/"><img id="logo-footer"
                                 ...
                                 src="https://ww2.ufps.edu.co/public/imagenes/template/footer/logoufpsvertical.png" alt="Logo Pie de Página"></a>
                        </div>
                    </div><!--/col-md-3-->
                    <!-- End About -->
                    ...
                    <div class="col-md-3 col-sm-4  md-margin-bottom-40">
                        ...
                        <ul class="list-unstyled latest-list">
                            <li><a href="
                                https://ww2.ufps.edu.co/universidad/seleccion" style="text-transform: none;">Proceso de selección</a></li>
